...
set_if_present auth.discovery_url "${LOOM_AUTH_DISCOVERY_URL:-}"
set_if_present auth.mcp_audience "${LOOM_AUTH_MCP_AUDIENCE:-}"
set_if_present auth.swagger_client_id "${LOOM_AUTH_SWAGGER_CLIENT_ID:-}"
