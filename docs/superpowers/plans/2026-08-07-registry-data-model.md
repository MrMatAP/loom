...
- [ ] `upgrade()` contains one `op.create_table(...)` per entity from Tasks 1-12: `tenant`, `principal`, `environment`, `agent`, `tool`, `datasource`, `entity`, `dataproduct_lineage`, `tool_data_binding`, `skill`, `skill_graph_node`, `skill_graph_edge`, `capability`, `capability_realization`, `metric`, `policy`, `role_binding`, `audit_event`, `eval_suite`, `eval_run` (20 tables).
